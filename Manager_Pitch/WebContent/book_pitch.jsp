	        ...
	        <div class="row form-group">
	            ...
	            <div class="col-lg-3">
	            	<html:select property="idPitch" styleClass="form-control">
	            		<html:optionsCollection name="footballPitchForm" property="listNamePitch" label="pitchName" value="idPitch" />
	            	</html:select>
	            </div>
	        </div>
	        <div class="row form-group">
	            ...
	            <div class="col-lg-3">
	            	 <html:select property="idHour" styleClass="form-control">
	            		<html:optionsCollection name="hourForm" property="listHour" label="frametime" value="idHour" />
	            	</html:select> 
